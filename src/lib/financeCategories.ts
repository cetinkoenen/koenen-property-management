...
export const FINANCE_CATEGORY_OPTIONS: FinanceCategoryOption[] = [
  ...
  { value: "Allgemeinstrom", type: "expense" },
  ...
  { value: "Instandhaltungsrücklage", type: "expense" },
...
const CATEGORY_ALIAS_PAIRS: Array<[string, string]> = [
  ...
  ["tiefgaragenstrom", "Allgemeinstrom"],
  ["strom tiefgarage", "Allgemeinstrom"],
  ["instandhaltungsruecklage", "Instandhaltungsrücklage"],
  ["instandhaltungsrücklage", "Instandhaltungsrücklage"],
  ["erhaltungsruecklage", "Instandhaltungsrücklage"],
