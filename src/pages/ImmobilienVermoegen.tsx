...
const SECTION_FIELDS: Array<{ title: string; description: string; icon: typeof Home; fields: FieldConfig[] }> = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "landValue", label: "Bodenrichtwert (€/m²)", type: "number" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "primaryEnergyDemand", label: "Primärenergiebedarf (kWh/(m²a))" },
      { key: "primaryEnergyConsumption", label: "Primärenergieverbrauch (kWh/(m²a))" },
