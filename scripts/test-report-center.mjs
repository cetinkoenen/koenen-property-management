...
const realArrearsRent={...rent,rows:[{...rent.rows[0],months:Array.from({length:12},(_,i)=>({month:i+1,expected:i<9?1590:0,paid:i===5?1588:i===6?0:i<9?1590:0,open:i===5?2:i===6?1590:0,status:i===5||i===6?'partial':'paid'}))}]};
