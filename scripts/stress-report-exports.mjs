...
const rosensteinTaxUnit = await readFile(new URL("../src/lib/rosensteinTaxUnit.ts", import.meta.url), "utf8");
...
console.log("154 Stressfaelle fuer sichere und vollstaendige Berichtsexporte bestanden.");
